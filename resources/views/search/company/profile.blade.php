				...
				<div class="inner-box">
					<div class="row">
						<?php
							...
							$colContact = null;
							if (
								(isset($company->address) && !empty($company->address))
								|| (isset($company->phone) && !empty($company->phone))
								|| (isset($company->mobile) && !empty($company->mobile))
								|| (isset($company->fax) && !empty($company->fax))
							) {
