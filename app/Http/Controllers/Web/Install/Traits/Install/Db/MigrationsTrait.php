		...
		try {
			...
			if (isset($mail['driver'])) {
				...
				if ($mail['driver'] == 'mandrill') {
					$mail['mandrill_secret'] = $siteInfo['mandrill_secret'] ?? '';
					$mail['mandrill_host'] = $siteInfo['smtp_hostname'] ?? '';
					$mail['mandrill_port'] = $siteInfo['smtp_port'] ?? '';
					$mail['mandrill_encryption'] = $siteInfo['smtp_encryption'] ?? '';
					$mail['mandrill_username'] = $siteInfo['smtp_username'] ?? '';
					$mail['mandrill_password'] = $siteInfo['smtp_password'] ?? '';
					$mail['mandrill_email_sender'] = $siteInfo['smtp_email_sender'] ?? $appEmail;
				}
				if ($mail['driver'] == 'ses') {
